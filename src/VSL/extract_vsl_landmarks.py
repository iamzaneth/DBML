...
# ============================================================
# PROJECT PATHS FOR VSL
# ============================================================

PROJECT_ROOT = Path(__file__).resolve().parents[2]

MODEL_DIR = PROJECT_ROOT / "models"
INTERIM_BASE_DIR = PROJECT_ROOT / "data" / "interim" / "VSL"
OUTPUT_BASE_DIR = PROJECT_ROOT / "data" / "processed" / "VSL"
...
def save_feature_schema(output_base_dir: Path) -> None:
    ...
    schema = {
        "schema_version": "2.0",
        "file_format": ".npz",
        "description": "Optimized MediaPipe landmark dataset for VSL sign-language training. No duplicated combined tensors are stored.",
...
def main():
    ...
    if not INTERIM_BASE_DIR.exists():
        ...
        print("Bạn cần có cấu trúc: data/interim/VSL/<label>/*.mp4")
        return
